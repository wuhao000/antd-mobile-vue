...
<script lang="ts">
  ...
  import CodemirrorDirective from '@/packages/codemirror-directive';
  import title from '../../packages/codemirror-directive/demo/README.md';
  import props from '../../packages/codemirror-directive/demo/props.md';

  Vue.use(Anchor);
  Vue.use(CodemirrorDirective);
  @Component({
    name: 'ComponentDemo'
  })
