...
<script lang="ts">
  ...
  import DTimePicker from '@/packages/d-time-picker';
  import title from '../../packages/d-time-picker/demo/README.md';
  import props from '../../packages/d-time-picker/demo/props.md';
