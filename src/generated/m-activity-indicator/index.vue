...
<script lang="ts">
  ...
  import MActivityIndicator from '@/packages/m-activity-indicator';
  import title from '../../packages/m-activity-indicator/demo/README.md';
  import props from '../../packages/m-activity-indicator/demo/props.md';

  Vue.use(MActivityIndicator);
  @Component({
    name: 'ComponentDemo',
    components: {
      demo1
