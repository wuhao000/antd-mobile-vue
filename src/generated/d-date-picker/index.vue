...
<script lang="ts">
  ...
  import DDatePicker from '@/packages/d-date-picker';
  import title from '../../packages/d-date-picker/demo/README.md';
  import props from '../../packages/d-date-picker/demo/props.md';
