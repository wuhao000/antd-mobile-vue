...
<script lang="ts">
  ...
  import DPagination from '@/packages/d-pagination';
  import title from '../../packages/d-pagination/demo/README.md';
  import props from '../../packages/d-pagination/demo/props.md';
