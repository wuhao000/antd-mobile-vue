...
<script lang="ts">
  ...
  import MNoticeBar from '@/packages/m-notice-bar';
  import title from '../../packages/m-notice-bar/demo/README.md';
  import props from '../../packages/m-notice-bar/demo/props.md';
