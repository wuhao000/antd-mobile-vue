...
<script lang="ts">
  ...
  import MDatePicker from '@/packages/m-date-picker';
  import title from '../../packages/m-date-picker/demo/README.md';
  import props from '../../packages/m-date-picker/demo/props.md';
