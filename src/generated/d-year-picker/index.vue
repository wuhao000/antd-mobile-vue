...
<script lang="ts">
  ...
  import DYearPicker from '@/packages/d-year-picker';
  import title from '../../packages/d-year-picker/demo/README.md';
  import props from '../../packages/d-year-picker/demo/props.md';
