...
<script lang="ts">
  ...
  import DColorPicker from '@/packages/d-color-picker';
  import title from '../../packages/d-color-picker/demo/README.md';
  import props from '../../packages/d-color-picker/demo/props.md';

  Vue.use(Anchor);
  Vue.use(DColorPicker);
  @Component({
    name: 'ComponentDemo',
    components: {
      demo1
