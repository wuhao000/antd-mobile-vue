<template>
  <div>
    <div class="toc-affix">
      <d-anchor :get-container="getContainer"
        ...
        <d-anchor-link v-show="false" href="#functions"
                       title="方法"/>
        <d-anchor-link v-show="true" href="#slots"
                       title="插槽"/>
      </d-anchor>
    </div>
    <div id="basic">
    ...
    <markdown :source="props"/>
		<div class="markdown-body" id="slots">
      <span></span>
      <h2>插槽说明</h2>
    </div>
    <markdown :source="slots"/>
 </div>
</template>
...
<script lang="ts">
  ...
  import DTransfer from '@/packages/d-transfer';
  import title from '../../packages/d-transfer/demo/README.md';
  import props from '../../packages/d-transfer/demo/props.md';
  import slots from '../../packages/d-transfer/demo/slots.md';
