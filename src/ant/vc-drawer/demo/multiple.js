  ...
  render: function render() {
    ...
    return h('div', [h(
      ...
      [h(
        ...
        {
          on: {
            'click': this.onClick.bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this)
          }
        },
        ['\u6253\u5F00\u62BD\u5C49']
      )]
      ...
      Drawer,
      {
        ...
        on: {
          'maskClick': this.onClick.bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this)
        },
