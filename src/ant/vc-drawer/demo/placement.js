    ...
    return h('div', [this.childShow && h(
      ...
      ['\u9009\u62E9\u4F4D\u7F6E\uFF1A', h(
        'select',
        {
          ...
          on: {
            'change': this.onChange.bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this).bind(this)
          }
        },
        [h(
          'option',
