...
import { getComponentFromProp, getStyle } from '../_util/props-util';
  ...
  render: function render(h) {
    ...
    var noticeNodes = notices.map(function(notice, index) {
      ...
      var noticeProps = {
        ...
        on: {
          close: close,
          click: (notice.onClick.bind(notice).bind(notice).bind(notice).bind(notice).bind(notice) && notice.onClick.bind(notice).bind(notice).bind(notice).bind(notice).bind(notice).bind(notice)) || noop
        },
        style: style,
        'class': className,
        key: key
