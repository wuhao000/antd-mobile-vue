...
let DatePicker = class DatePicker extends DatePickerProps {
    ...
    render() {
        ...
        const datePicker = (
        // @ts-ignore
        <RCDatePicker minuteStep={this.minuteStep} locale={DatePickerLocale} minDate={this.minDate} maxDate={this.maxDate} mode={this.mode} pickerPrefixCls={this.pickerPrefixCls} prefixCls={this.prefixCls} date={this.getDate()} use12Hours={this.use12Hours} onInput={(v) => {
            this.onInput(v);
        }} onValueChange={(...args) => {
        ...
        return (<PopupDatePicker datePicker={datePicker} WrapComponent="div" transitionName="am-slide-up" maskTransitionName="am-fade" {...this.$props} title={this.title} disabled={this.disabled} editable={this.editable} visible={visible} prefixCls={popupPrefixCls} date={this.getDate()} dismissText={this.dismissText || dismissText} okText={this.okText || okText} ref={this.fixOnOk} onVisibleChange={this.onVisibleChange}>
