...
const DatePicker = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const defaultMinDate = ref(null);
        const defaultMaxDate = ref(null);
    ...
    render() {
        ...
        return (
        // @ts-ignore
        <MultiPicker style={multiStyle} rootNativeProps={rootNativeProps} prefixCls={prefixCls} selectedValue={value} {...{
        ...
        <Picker {...{
            ...
            {p.props.children.map(item => (<Picker.Item key={item.value} value={item.value} label={item.label}>
              </Picker.Item>))}
          </Picker>))}
      </MultiPicker>);
    }
