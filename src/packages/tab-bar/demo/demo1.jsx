...
export default defineComponent({
    ...
    render() {
        ...
        <m-tab-bar unselectedTintColor="#949494" tintColor="#33A3F4" vModel={this.state.selectedTab} barTintColor="white" hidden={this.state.hidden}>
        ...
        }}/>} title="Koubei" key="Koubei" badge={'new'}>
        ...
        }}/>} title="Friend" key="Friend" dot={true}>
