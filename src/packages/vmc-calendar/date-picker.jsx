...
const DatePicker = defineComponent({
    name: 'DatePicker',
    props: Object.assign(Object.assign({}, DatePickerProps), { displayMode: { type: Boolean, default: false } }),
    setup(props, { emit }) {
        const genMonthComponent = (data) => {
            if (!data) {
                return;
            }
            // @ts-ignore
            return <SingleMonth key={data.title} locale={props.locale || {}} monthData={data} displayMode={props.displayMode} rowSize={props.rowSize} onCellClick={(day) => {
                onCellClick(day);
            }} getDateExtra={props.getDateExtra} callback={(dom) => {
        ...
        const computeHeight = (data, singleMonth) => {
    ...
    render() {
        ...
        <div class="wrapper" style={{
            overflowX: 'hidden',
            overflowY: 'visible'
        }} ref={this.setWrapper} {...wrapperEvents}>
