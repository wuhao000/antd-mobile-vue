...
export default defineComponent({
    ...
    props: Object.assign(Object.assign(Object.assign({}, simpleFormComponentProps), pureInputComponentProps), { 
         ...
         * 默认值
         */
        defaultDate: { type: Date, default: () => new Date() }, minDate: { type: Date, default: () => MIN_DATE }, maxDate: { type: Date, default: () => MAX_DATE }, pickTime: { type: Boolean, default: false }, type: { type: String, default: 'range' }, placeholder: { type: String } }),
    ...
    render() {
        const slots = {
            default: () => {
                return [
                    <Calendar {...this.inputProps} {...this.listeners} value={this.currentValue} visible={this.visible} onClose={this.onClose} onConfirm={this.onConfirm} defaultValue={this.currentValue} v-slots={this.inputSlots} style={this.cssStyle}>
            {this.getDefaultSlot()}
          </Calendar>,
        ...
        return <List.Item text={!!this.displayValue} required={this.required} touchFeedback={true} disabled={this.disabled} arrow="horizontal" v-slots={slots} title={this.title} onClick={this.onClick}>
