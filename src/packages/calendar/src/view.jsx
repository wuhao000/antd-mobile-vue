...
export default defineComponent({
    ...
    render() {
        ...
        }} {...Object.assign(Object.assign({}, this.$props), { type: 'one', displayMode: true, minDate: this.minDate || beginOfMonth(), maxDate: this.maxDate || endOfMonth() })} visible={this.state.visible}/>);
    }
});
