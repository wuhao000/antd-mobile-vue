...
CustomChildren = tslib_1.__decorate([
    Component({
        name: 'CustomChildren'
    })
], CustomChildren);
let Demo = class Demo extends Vue {
    ...
    render() {
        return (<m-list className="date-picker-list" style={{ backgroundColor: 'white' }}>
          <m-date-picker value={this.state.date} onChange={date => this.state.date = date}>
