...
let Index = class Index extends Vue {
    ...
    renderStyle({ sidebarStyle = null, isTouching = null, overlayStyle = null, contentStyle = null }) {
    ...
    get onPan() {
        ...
        return {
            ...
            onPanMove: (status) => {
                ...
                const canScrollOffset = -this.overlayRef.scrollWidth + this.overlayRef.clientWidth;
    ...
    render() {
        ...
        if (this.state.touchSupported && touch) {
            if (open) {
                ...
                dragHandle = (<div class={`${prefixCls}-draghandle`} style={this.dragHandleStyle} onTouchStart={this.onTouchStart.bind(this)} onTouchMove={this.onTouchMove.bind(this)} onTouchEnd={this.onTouchEnd.bind(this)} onTouchCancel={this.onTouchEnd.bind(this)} ref={'dragHandle'}/>);
            }
        }
        return (<div class={classNames(rootCls)} on={rootProps}>
        <div class={`${prefixCls}-sidebar`} style={sidebarStyle} ref={'sidebar'}>
          {sidebar}
        </div>
        <div class={`${prefixCls}-overlay`} style={overlayStyle} role={'presentation'} ref={'overlay'} onclick={this.onOverlayClicked.bind(this)}/>
...
], Index.prototype, "prefixCls", void 0);
tslib_1.__decorate([
    Prop({
        default: () => {
            return {};
...
], Index.prototype, "sidebarStyle", void 0);
tslib_1.__decorate([
    Prop({
        default: () => {
            return {};
...
], Index.prototype, "contentStyle", void 0);
tslib_1.__decorate([
    Prop({
        default: () => {
            return {};
...
], Index.prototype, "overlayStyle", void 0);
tslib_1.__decorate([
    Prop({
        default: () => {
            return {};
...
], Index.prototype, "dragHandleStyle", void 0);
tslib_1.__decorate([
    Prop({})
], Index.prototype, "sidebar", void 0);
tslib_1.__decorate([
    Prop({
        type: Boolean,
        default: false
    })
], Index.prototype, "docked", void 0);
tslib_1.__decorate([
    Prop({
        type: Boolean,
        default: false
    })
], Index.prototype, "open", void 0);
tslib_1.__decorate([
    Prop({
        type: Boolean,
        default: true
    })
], Index.prototype, "transitions", void 0);
tslib_1.__decorate([
    Prop({
        type: Boolean,
        default: true
    })
], Index.prototype, "touch", void 0);
tslib_1.__decorate([
    Prop({
        type: Boolean,
        default: true
    })
], Index.prototype, "enableDragHandle", void 0);
tslib_1.__decorate([
    Prop({ default: 'left' })
], Index.prototype, "position", void 0);
tslib_1.__decorate([
    Prop({
        type: Number,
        default: 30
    })
], Index.prototype, "dragToggleDistance", void 0);
tslib_1.__decorate([
    Prop({
        default: () => {
            return () => {
...
], Index.prototype, "onOpenChange", void 0);
