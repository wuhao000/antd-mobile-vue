...
function (_BaseInputComponent) {
  ...
  function MCalendarItem() {
    ...
    return (_temp = _this = _BaseInputComponent.call.apply(_BaseInputComponent, [this].concat(args)) || this, _initializerDefineProperty(_this, "text", _descriptor, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "title", _descriptor2, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "defaultDate", _descriptor3, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "minDate", _descriptor4, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "maxDate", _descriptor5, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "pickTime", _descriptor6, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "type", _descriptor7, _assertThisInitialized(_this)), _initializerDefineProperty(_this, "placeholder", _descriptor8, _assertThisInitialized(_this)), _this.currentValue = [], _this.visible = false, _temp) || _assertThisInitialized(_this);
  }
...
}(BaseInputComponent), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "text", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "defaultDate", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "pickTime", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2.prototype, "valueChanged", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "valueChanged"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "currentValueChanged", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "currentValueChanged"), _class2.prototype)), _class2)) || _class);
